...
public class MemberController {
    ...
    public ResponseEntity<Page<MemberDto>> getMemberWithRecommend(@PageableDefault(size = 10, sort = "project_count", direction = Sort.Direction.DESC) Pageable pageable) {
